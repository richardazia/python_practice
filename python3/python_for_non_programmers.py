...
# For the calling in sick challenge I struggled with the logic. I wrote more code
# than I needed to write. I understand the logic. 
# No need to write if actually sick == True
# Use just one =, not two. We're setting a variable, not checking an equivalence.
